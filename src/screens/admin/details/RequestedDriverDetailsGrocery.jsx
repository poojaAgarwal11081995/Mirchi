...
import { reqEditDriverGrocery, reqDriverDetailsGrocery, reqRegionList, reqGetCategoryListGrocery, reqCountryList, reqStateList, reqCityList } from '../../../actions';
...
class RequestedDriverDetailsGrocery extends BaseComponent {
    constructor(props) {
        super(props)
        this.state = {
...
RequestedDriverDetailsGrocery.propTypes = {
...
export default connect(mapStateToProps, { reqEditDriverGrocery, reqDriverDetailsGrocery, reqRegionList, reqGetCategoryListGrocery, reqCountryList, reqStateList, reqCityList })(withStyles(styles)(RequestedDriverDetailsGrocery));
