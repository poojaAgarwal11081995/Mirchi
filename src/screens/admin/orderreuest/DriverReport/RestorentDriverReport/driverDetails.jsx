...
function RestaurentDriverDetails(props) {
						...
						? data
								...
								.map((n) => (
									<TableRow key={n._id}>
										...
										<TableCell align="center">{n.driver_name}</TableCell>
										<TableCell align="center">{n.order_number}</TableCell>
										<TableCell align="center">{n.order_date_placed}</TableCell>
										<TableCell align="center">
											{n.order_date_confirmed}
										</TableCell>
										<TableCell align="center">
...
RestaurentDriverDetails.propTypes = {
	classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(RestaurentDriverDetails);
