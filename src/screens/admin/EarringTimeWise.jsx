...
import { reqListDriverEarningTimeWise } from '../../actions';
...
class EarringTimeWise extends BaseComponent {
    constructor(props) {
        super(props)
    ...
    handleResponse = (nextProps) => {
        ...
        if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
            ...
            if (nextProps[Constants.KEY_TYPE] == types.API_DRIVER_EARNING_PER_WEEK) {
                ...
                if (nextProps[Constants.KEY_RESPONSE].hasOwnProperty(Constants.KEY_DATA)) {
                    ...
                    [Constants.KEY_DATA][Constants.KEY_DRIVER_EARNING_LIST];

                    respObj[Constants.KEY_DRIVER_EARNING_LIST] = nextProps[Constants.KEY_RESPONSE]
                    [Constants.KEY_DATA][Constants.KEY_DRIVER_EARNING_LIST];
    ...
    listDriverEarning = () => {
        this.props.reqListDriverEarningTimeWise({
...
export default connect(mapStateToProps, { reqListDriverEarningTimeWise })(withStyles(styles)(EarringTimeWise));
