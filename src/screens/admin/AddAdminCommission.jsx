...
import AdminCommisionLoadMoreTable from "../../tables/AdminCommisionLoadMoreTable";
...
class AddAdminCommission extends BaseComponent {
	constructor(props) {
		super(props);
	...
	deleteDriverFareItem = (_id) => {
		...
		//this.props.reqChildDeleteDriverDistance(data, this)
	};
	...
	addDriverDistanceCharge = (array) => {
		...
		this.props.reqAddAdminCommission(data, this);
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
			...
			if (nextProps[Constants.KEY_TYPE] === types.API_ADD_LOCALITY) {
				...
				nextProps[Constants.KEY_TYPE] === types.API_ADD_ADMIN_COMMISSION
			) {
				...
				nextProps[Constants.KEY_TYPE] === types.API_EDIT_ADMIN_COMMISSION
			) {
				toast(nextProps[Constants.KEY_RESPONSE][Constants.KEY_MESSAGE]);
				respObj = {
					[Constants.KEY_SHOW_PROGRESS]: false,
...
export default connect(mapStateToProps, {
	...
	reqStateList,
	reqCityList,
})(withStyles(styles)(AddAdminCommission));
