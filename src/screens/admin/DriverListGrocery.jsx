...
import AddDriverTableGrocery from "../../tables/AddDriverTableGrocery";
const animatedComponents = makeAnimated();

let TEXTFIELD_XS = 12;
const userData = undefined;
let changeAbleDriverId = -1;
class DriverListGrocery extends BaseComponent {
	constructor(props) {
		super(props);
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_RESPONSE)) {
			if (nextProps[Constants.KEY_TYPE] === types.API_DRIVER_LIST_GROCERY) {
				respObj = {
	...
	navigateEarringPage() {
		// alert('esds')
		this.props.history.push({
			pathname: Constants.SCREEN_EARRING_PAGE_GROCERY,
		});
	}
...
export default connect(mapStateToProps, {
	...
	reqStateList,
	reqCityList,
})(withStyles(styles)(DriverListGrocery));
