...
import { reqRatingReviewListGrocery } from "../../actions";
...
import ReviewItems from "./orderreuest/ReviewItems";
...
import ReviewItemsGrocery from "./orderreuest/ReviewItemsGrocery";
const animatedComponents = makeAnimated();

let TEXTFIELD_XS = 12;

let userData = undefined;
class ReviewManagementGrocery extends BaseComponent {
	constructor(props) {
		super(props);
		...
		this.state = {
			...
			[Constants.KEY_SEARCH_CUSTOMER]: undefined,
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
			...
			if (
				nextProps[Constants.KEY_TYPE] === types.API_RATING_REVIEW_LIST_GROCERY
			) {
				respObj = {
...
ReviewManagementGrocery.propTypes = {
...
export default connect(mapStateToProps, { reqRatingReviewListGrocery })(
	withStyles(styles)(ReviewManagementGrocery),
);
