...
import {
	reqDeleteDriverDistanceChargeItem,
	reqDriverDistanceChargeList,
	reqRegionList,
	reqDeleteRegion,
	reqCountryList,
	reqStateList,
...
class DriverFareList extends BaseComponent {
	constructor(props) {
		super(props);
		_context = props;
	...
	getDriverChargeCList = (selectedOption) => {
		...
		this.props.reqDriverDistanceChargeList(data, this);
	};
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
			...
			if (nextProps[Constants.KEY_TYPE] === types.API_LOCALITY_LIST) {
				...
				nextProps[Constants.KEY_TYPE] === types.API_DRIVER_DISTANCE_CHARGE_LIST
			) {
				respObj = {
					[Constants.KEY_SHOW_PROGRESS]: false,
					[Constants.KEY_DATA]:
...
export default connect(mapStateToProps, {
	...
	reqStateList,
	reqCityList,
})(withStyles(styles)(DriverFareList));
