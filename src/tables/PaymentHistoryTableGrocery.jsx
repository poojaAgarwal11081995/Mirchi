...
function PaymentHistoryTableGrocery(props) {
	...
	return (
		<Paper className={classes.root}>
			<Table className={classes.table}>
				<TableHead>
					<TableRow>
						<TableCell align="justify">Store Name</TableCell>
								...
								.map((n, index) => (
									<TableRow key={n.id}>
										...
										<TableCell align="center">
											{" "}
											{n[Constants.KEY_GROCERY_DETAILS] != undefined &&
												n[Constants.KEY_GROCERY_DETAILS][Constants.KEY_PHONE]}
										</TableCell>
										{/* <TableCell align="center">{n.email}</TableCell> */}
										<TableCell align="center">
											{n[Constants.KEY_GROCERY_DETAILS] != undefined &&
											n[Constants.KEY_GROCERY_DETAILS][Constants.KEY_CITY][
												Constants.KEY_NAME
											] != undefined
												? n[Constants.KEY_GROCERY_DETAILS][Constants.KEY_CITY][
														Constants.KEY_NAME
...
PaymentHistoryTableGrocery.propTypes = {
	classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(PaymentHistoryTableGrocery);
