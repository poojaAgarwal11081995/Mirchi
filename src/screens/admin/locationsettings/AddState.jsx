...
import { reqAddState, reqCountryList } from "../../../actions";
...
class AddState extends BaseComponent {
	constructor(props) {
		super(props);
	...
	addStateName = (data) => {
		this.props.reqAddState(data, this);
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
			...
			if (nextProps[Constants.KEY_TYPE] === types.API_ADD_STATE) {
...
export default connect(mapStateToProps, { reqAddState, reqCountryList })(
	withStyles(styles)(AddState),
);
