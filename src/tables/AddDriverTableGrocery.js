...
function AddDriverTableGrocery(props) {
	...
	function handleClose(option, pos) {
		...
		if (option != undefined) {
			...
			if (option == Constants.ORDER_HISTORY) {
				...
				context.props.history.push({
					pathname: Utility.isAdmin && Constants.SCREEN_EARRING_PAGE_GROCERY,
					[Constants.KEY_GROCERY_DETAILS]: n,
				});
			}
		}
...
AddDriverTableGrocery.propTypes = {
	classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(AddDriverTableGrocery);
