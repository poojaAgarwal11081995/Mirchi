...
import { reqChangeStatusCoupon, reqCouponList, reqDeleteCoupon } from '../../actions';
...
let TEXTFIELD_XS = 12;
class DiscountManagement extends BaseComponent {
    constructor(props) {
        super(props)
    ...
    handleResponse = (nextProps) => {
        ...
        if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
            ...
            if (nextProps[Constants.KEY_TYPE] === types.API_LISTCOUPONCODE) {
                ...
                this.setState(respObj);
                this.getCouponList();
            } else if (nextProps[Constants.KEY_TYPE] === types.API_CHANGECOUPONCODESTATUS) {
                respObj = { [Constants.KEY_SHOW_PROGRESS]: false };
                this.setState(respObj);
                this.getCouponList();
            }
...
export default connect(mapStateToProps, { reqChangeStatusCoupon, reqCouponList, reqDeleteCoupon })(withStyles(styles)(DiscountManagement));
