...
function StateTable(props) {
	console.log("props.dataOb", props.dataOb);
	const {
		classes,
								...
								.map((dataObj, index) => (
									<TableRow key={dataObj[Constants.KEY_UNDERSCORE_ID]}>
										...
										<TableCell align="center">
											{dataObj[Constants.KEY_STATE_CODE]}
										</TableCell>
										<TableCell align="center">
										...
										{/* <TableCell align="center">
									{dataObj[Constants.KEY_CREATED].slice(11, 16)}
								</TableCell> */}
										...
										<TableCell align="center">
											{[
												...
												<Link
													...
													to={Constants.SCREEN_EDIT_STATE}>
													<IconButton
														aria-label="Detail"
														onClick={() => {
