...
import { reqOrderCompletedGrocery } from '../actions/';
...
class DriverDetailsOnOrderTable extends Component {
 ...
 orderCompleted = () => {
    ...
    [Constants.KEY_UNDERSCORE_ID]: this.state[Constants.KEY_UNDERSCORE_ID],
        ...
        this.props.reqOrderCompletedGrocery(data,this)
    }
    ...
    handleResponse = async (nextProps) => {
        ...
        if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
            ...
            if (nextProps[Constants.KEY_TYPE] === types.API_ORDER_COMPLETED_GROCERY) {
...
export default connect(mapStateToProps, { reqOrderCompletedGrocery })(withStyles(styles)(DriverDetailsOnOrderTable));