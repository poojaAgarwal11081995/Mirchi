                    ...
                    <Card className={classes.card}>
                        ...
                        {this.state[Constants.KEY_ORDER_DETAILS] != undefined && <CardContent >
                            ...
                            {/* <CardActions className={classes.titlegreen} disableSpacing style={{
                                ...
                                <Typography className={classes.pos} color="textSecondary">
                                    {
                                        this.state[Constants.KEY_RETSRO_DETAILS][Constants.KEY_NAME]
                                    }
                                </Typography>
                            </CardActions> */}
                            ...
                            ></OrderTimeTable>
                            <UserDetailsOnOrderTable
                                style={{ marginTop: 20 }}
                                classes={classes}
                                context={this}
                                restroDetails={this.state[Constants.KEY_RETSRO_DETAILS]}
...
export default connect(mapStateToProps, { reqOrderDetails, reqAddProduct })(withStyles(styles)(OrderDetails));
