const key = "AIzaSyBnbQgQS0VMifjJ69qKQa9GjZJP6Aa5Tg4";

export const G_API_URL = `https://maps.googleapis.com/maps/api/js?key=${key}&&v=3.exp&libraries=geometry,drawing,places`;

export const LATLNG = { to: "26.9048, 75.7489", from: "26.906955, 75.799071" };
...
export const locationsList = {
  Jaisalmer: convertTolatLng(LATLNG.to, "Jaisalmer"),
  Jaipur: convertTolatLng(LATLNG.from, "Jaipur")
