...
import { reqAddCity, reqCountryList, reqStateList } from "../../../actions";
...
class AddCity extends BaseComponent {
	constructor(props) {
		super(props);
	...
	addCity = (event) => {
		...
		this.props.reqAddCity(data, this);
		// this.goBack();
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
			...
			if (nextProps[Constants.KEY_TYPE] === types.API_ADD_CITY) {
