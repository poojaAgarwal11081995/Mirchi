...
class AddGroceryStore extends BaseComponent {
	constructor(props) {
		super(props);
		this.state = {
			[Constants.KEY_IMG]: "",
			...
			supportDeliveryArray: [
				{ label: Constants.KEY_TRUE, [Constants.KEY_VALUE]: true },
				{ label: Constants.KEY_FALSE, [Constants.KEY_VALUE]: false },
			],
			// restroTypeArray: [{ label: Constants.KEY_KIRANA_STORE, [Constants.KEY_VALUE]: Constants.GROCERY_TYPE_KIRANA_STORE },
			// { label: Constants.KEY_GENERAL_STORE, [Constants.KEY_VALUE]: Constants.GROCERY_TYPE_GENERAL_STORE },
			// { label: Constants.KEY_DEPARTMENTAL_STORE, [Constants.KEY_VALUE]: Constants.GROCERY_TYPE_DEPARTMENTAL_STORE },
			// { label: Constants.KEY_OTHER, [Constants.KEY_VALUE]: Constants.GROCERY_TYPE_OTHER }],
	...
	handleChangeStoreType = (selectedOption, isDeleted) => {
		this.setState({
								...
								<div class="col-sm ">
									<Grid
										...
										<CommoanAutocomplete
											...
											options={this.state[Constants.STORE_TYPE_LIST_DATA]}
											components={animatedComponents}
							...
							<div class="row">
                                ...
                                <div class="col-sm ">
                                    <CommonMultipleSelectorImg
                                        ...
                                        value={this.state[Constants.KEY_KITCHEN_IMG_NAME].toString()}
                                        variant="outlined"
								...
								{/* <div class="col-sm ">
                                    <CommonImageSelector
                                        ...
                                        clearPress={() => {
                                            this.viewImage(this.state[Constants.KEY_FSSAI_LICENCE_IMG] != undefined ?
							...
							<div class="row">
								...
								{/* <div class="col-sm ">
                                    <CommonMultipleSelectorImg
                                        ...
                                        value={this.state[Constants.KEY_DINING_PACKAGING_IMG_NAME].toString()}
                                        variant="outlined"
                                        onChange={this.diningImagePress}
                                        clearPress={() => {
                                            this.viewImageMultiple(
                                                this.state[Constants.KEY_DINING_PACKAGING_IMG] != undefined ?
	...
	checkVaidation = (event) => {
		...
		let selectedRegionName =
			this.state.selectedRegion != undefined && this.state.selectedRegion != ""
				? this.state.selectedRegion[Constants.KEY_STORE_NAME]
				: "";
		let selectedCityName =
			this.state.selectedCity != undefined && this.state.selectedCity != ""
				? this.state.selectedCity[Constants.KEY_STORE_NAME]
				: "";
		let selectedStateName =
			this.state.selectedState != undefined && this.state.selectedState != ""
				? this.state.selectedState[Constants.KEY_STORE_NAME]
				: "";
		let selectedCountryName =
			this.state.selectedCountry != undefined &&
			this.state.selectedCountry != ""
				? this.state.selectedCountry[Constants.KEY_STORE_NAME]
				: "";
		...
		if (Utility.checkAddGroceryVaidation(data, imageSource, this)) {
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps["message"] !== undefined && nextProps["message"] !== "") {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
			...
			if (nextProps[Constants.KEY_TYPE] === types.API_ADDGROCERY) {
				// alert("API_ADDGROCERY");
				...
				if (userData != undefined && userData != null) {
					...
					toast(
						"Grocery Store details have been submitted. Please wait for the admin verification. You will be notified on your email address.",
						toastStyle,
					);
				}
				setTimeout(() => {
...
export default connect(mapStateToProps, {
	...
	reqStateList,
	reqCityList,
})(withStyles(styles)(AddGroceryStore));
