...
import {
	reqRestroOnlineChangeStatus,
	reqOrderListNew,
	reqOrderListPreparing,
	reqOrderListRedy,
	reqOrderListPast,
	reqOrderList,
	reqChageOrderStatus,
...
class RestroDashboard extends BaseComponent {
	constructor(props) {
		super(props);
...
export default connect(mapStateToProps, {
	...
	reqOrderList,
	reqChageOrderStatus,
})(withStyles(styles)(RestroDashboard));
