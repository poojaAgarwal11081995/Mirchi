...
import { reqListDriverEarningTimeWiseGrocery } from '../../actions';
...
class GroceryEarringTimeWise extends BaseComponent {
    constructor(props) {
        super(props)
    ...
    handleClick = index => {
        var list = this.state[Constants.KEY_DRIVER_EARNING_LIST];
        list[index].isOpen = list[index].isOpen != undefined ? !list[index].isOpen : true
        this.setState({
            [Constants.KEY_DRIVER_EARNING_LIST]: list
        })
        // this.setState({
                ...
                <Fragment>
                    <div className={classes.appBarSpacer} style={{ paddingTop: 50, }}>
                        ...
                        <List style={{ display: "flex" }}>
                            {this.state[Constants.KEY_DRIVER_EARNING_LIST].map((item, index) => {
                                                            ...
                                                            <ListItem button
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <Grid>
                                                                            <ListItemText
                                                                                primary={Constants.RUPEES_SIGN + itemChild[Constants.KEY_DELIVERY_CHARGE]} />
                                                                        </Grid>
                                                                    </Grid>
                                                                    <ListItemText
    ...
    handleResponse = (nextProps) => {
        ...
        if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
            ...
            if (nextProps[Constants.KEY_TYPE] == types.API_DRIVER_EARNING_PER_WEEK_GROCERY) {
                ...
                if (nextProps[Constants.KEY_RESPONSE].hasOwnProperty(Constants.KEY_DATA)) {
                    ...
                    [Constants.KEY_DATA][Constants.KEY_DRIVER_EARNING_LIST_GROCERY];

                    respObj[Constants.KEY_DRIVER_EARNING_LIST_GROCERY] = nextProps[Constants.KEY_RESPONSE]
                    [Constants.KEY_DATA][Constants.KEY_DRIVER_EARNING_LIST_GROCERY];
    ...
    listDriverEarning = () => {
        this.props.reqListDriverEarningTimeWiseGrocery({
            [Constants.KEY_DELIVERY_MAN_ID]: earningDetails[Constants.KEY_DELIVERY_MAN_ID],
...
GroceryEarringTimeWise.propTypes = {
...
export default connect(mapStateToProps, { reqListDriverEarningTimeWiseGrocery })(withStyles(styles)(GroceryEarringTimeWise));
