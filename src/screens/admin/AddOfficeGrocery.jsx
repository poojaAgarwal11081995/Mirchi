...
class AddOfficeGrocery extends BaseComponent {
	constructor(props) {
		super(props);
		this.state = {
	...
	checkVaidation = (event) => {
		...
		var data = {
			...
			// [Constants.KEY_ADDRESS_2]: this.state[Constants.KEY_ADDRESS_2],
			// [Constants.KEY_ADDRESS_3]: this.state.[Constants.KEY_ADDRESS_3],
			// [Constants.KEY_ADDRESS_4]:this.state.[Constants.KEY_ADDRESS_4],
	...
	addOfficeReq = (data) => {
		...
		this.props.reqAddOfficeGrocery(data, this);
	};
	...
	getOfficeDetail = () => {
		...
		this.props.reqOfficeDetailGrocery(data, this);
	};
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
			...
			if (nextProps[Constants.KEY_TYPE] === types.API_ADD_OFFICE_GROCERY) {
			...
			if (
				nextProps[Constants.KEY_TYPE] === types.API_OFFICE_DETAIL_GROCERY &&
...
export default connect(mapStateToProps, {
	...
	reqStateList,
	reqCityList,
})(withStyles(styles)(AddOfficeGrocery));
