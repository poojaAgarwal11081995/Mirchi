...
export default function ChartOrdersGrocery(props) {
	const classes = useStyles();

	{
		console.log("props:::::grocery>>>>>", props.props);
	}

	return (
		<React.Fragment>
			<Title>Recent Grocery Store Orders</Title>
			<Table size="small">
				<TableHead>
					<TableRow>
						<TableCell align="center">Grocery Store Name</TableCell>
											...
											{[
												<Link
													...
													onClick={() => {
														...
														//     Constants.KEY_GROCERY_ID, n[Constants.KEY_GROCERY_ID]);
													}}>
													<IconButton
														...
														onClick={() => {
															...
															props.props.history.push({
																pathname: Utility.isAdmin()
																	? Constants.SCREEN_SCREEN_CHECK_REQUEST_GROCERY
																	: Constants.SCREEN_DASHBOARD_GROCERY,
															});
														}}>
														<EyeIcon />
													</IconButton>
