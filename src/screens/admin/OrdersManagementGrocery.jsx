...
import { reqOrderListForAdminGrocery } from "../../actions";
...
import AdminAllOrdersItemGrocery from "./orderreuest/AdminAllOrdersItemGrocery";
const animatedComponents = makeAnimated();

let TEXTFIELD_XS = 12;

let userData = undefined;
class OrdersManagementGrocery extends BaseComponent {
	constructor(props) {
		super(props);
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
			...
			if (
				nextProps[Constants.KEY_TYPE] === types.API_ORDER_LIST_FOR_ADMIN_GROCERY
			) {
				respObj = {
	...
	getOrdersList = () => {
		...
		this.props.reqOrderListForAdminGrocery(data, this);
	};
...
OrdersManagementGrocery.propTypes = {
...
export default connect(mapStateToProps, { reqOrderListForAdminGrocery })(
	withStyles(styles)(OrdersManagementGrocery),
);
