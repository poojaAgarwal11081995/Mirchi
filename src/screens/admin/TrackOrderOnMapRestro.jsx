...
import { reqOrderDetails ,reqGetDriverCurrentLoc } from '../../actions';
...
class TrackOrderOnMapRestro extends Basecomponent {
    ...
    renderMarkers = (map, maps) => {
        ...
        var flightPath = new window.google.maps.Polyline({
            path: [
                ...
                { 'lat': get(this.state[Constants.KEY_ORDER_DETAILS], 'restro_detail.lat', ''), 'lng': get(this.state[Constants.KEY_ORDER_DETAILS], 'restro_detail.lng', '') },
                ...
                // { 'lat': 27.0148, 'lng': 75.7844 },
                // { 'lat': 26.8992, 'lng': 75.8625 },
    ...
    getDriverLocation = () => {
        ...
        this.props.reqGetDriverCurrentLoc(data, this)
    }
    getMyLocation = () => {
        console.log('marker>>>>>>>>');
    ...
    getOrderDetails = (_id) => {
        ...
        this.props.reqOrderDetails(data, this)
    }
    ...
    handleResponse = (nextProps) => {
        ...
        if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
            ...
            let retstroDetails  = data[Constants.KEY_RETSRO_DETAILS];
            ...
            respObj = {
                ...
                [Constants.KEY_RETSRO_DETAILS]: retstroDetails,
        ...
        return (
            <Fragment >
                ...
                >
                    ...
                    <MarkerFirst
                        lat={get(this.state[Constants.KEY_ORDER_DETAILS], 'restro_detail.lat', '')}
                        lng={get(this.state[Constants.KEY_ORDER_DETAILS], 'restro_detail.lng', '')}
                        name="Vendor"
                        color="Red"
                    />
...
TrackOrderOnMapRestro.propTypes = {
...
export default connect(mapStateToProps, { reqOrderDetails,reqGetDriverCurrentLoc  })(withStyles(styles)(TrackOrderOnMapRestro));
