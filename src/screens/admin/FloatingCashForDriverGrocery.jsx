...
class FloatingCashForDriverGrocery extends BaseComponent {
	constructor(props) {
		super(props);
	...
	firstBtnClick = () => {
		...
		this.props.reqReceiveFloatingCashGrocery(
			{
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_RESPONSE)) {
			if (
				...
				toast("deleted driver successfully");
				this.setState(respObj);
				this.getDriverList();
			} else if (
				...
				respObj = { [Constants.KEY_SHOW_PROGRESS]: false };
				toast("driver status changed successfully");
				this.setState(respObj);
				this.getDriverList();
			} else if (
				nextProps[Constants.KEY_TYPE] ===
				...
				respObj = { [Constants.KEY_SHOW_PROGRESS]: false };
				toast("driver doc status changed successfully");
				this.setState(respObj);
	...
	getDriverList = () => {
		...
		this.props.reqFloatingCashForAllDriverGrocery(data, this);
	};
...
FloatingCashForDriverGrocery.propTypes = {
...
export default connect(mapStateToProps, {
	...
	reqStateList,
	reqCityList,
})(withStyles(styles)(FloatingCashForDriverGrocery));
