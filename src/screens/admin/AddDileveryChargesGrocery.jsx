...
import DileveryChargeLoadMoreTableGrocery from "../../tables/DileveryChargeLoadMoreTableGrocery";
...
class AddDileveryChargesGrocery extends BaseComponent {
	constructor(props) {
		super(props);
			...
			return (
				<Fragment>
					...
					<Grid container>
						...
						<DileveryChargeLoadMoreTableGrocery
							ref={this.child}
							classes={classes}
							context={this}
	...
	addDileveryCharge = (array) => {
		...
		this.props.reqAddDileveryChargeGrocery(data, this);
	};
...
AddDileveryChargesGrocery.propTypes = {
...
export default connect(mapStateToProps, {
	...
	reqStateList,
	reqCityList,
})(withStyles(styles)(AddDileveryChargesGrocery));
