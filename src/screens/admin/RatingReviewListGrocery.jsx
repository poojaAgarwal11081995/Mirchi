...
import { reqDeleteDriverDistanceChargeItemGrocery, reqDriverDistanceChargeListGrocery, reqRegionList, reqDeleteRegion, reqCountryList, reqStateList, reqCityList } from '../../actions';
...
class RatingReviewListGrocery extends BaseComponent {
    constructor(props) {
        super(props)
        _context = props;
    ...
    handleResponse = (nextProps) => {
        ...
        if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
            ...
            else if (nextProps[Constants.KEY_TYPE] === types.API_DRIVER_DISTANCE_CHARGE_ITEM_DELETE_GROCERY) {
...
RatingReviewListGrocery.propTypes = {
...
export default connect(mapStateToProps, { reqDeleteDriverDistanceChargeItemGrocery, reqDriverDistanceChargeListGrocery, reqRegionList, reqDeleteRegion, reqCountryList, reqStateList, reqCityList })(withStyles(styles)(RatingReviewListGrocery));
