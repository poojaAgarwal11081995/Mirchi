...
function AdminAllOrdersItemGroceryCancel(props) {
	...
	const [options, setOptions] = React.useState([
		...
		Constants.ORDER_STATUS_STR_CANCEL_BY_GROCERY,
			...
			<Table className={classes.table}>
				<TableHead>
					<TableRow>
						...
						<TableCell align="justify">Vendor Name</TableCell>
						...
						? data
								...
								.map((n, index) => (
									<TableRow key={n._id}>
										...
										<TableCell align="center">
											{Utility.getStatusValueGrocery(n.status) + ""}
										</TableCell>
										<TableCell align="center">
											{[
												<Tooltip
...
AdminAllOrdersItemGroceryCancel.propTypes = {
	classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(AdminAllOrdersItemGroceryCancel);
