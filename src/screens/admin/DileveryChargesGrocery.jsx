...
import {
	reqDeleteDileveryChargeItemGrocery,
	reqGetDileveryChargeListGrocery,
	reqRegionList,
	reqDeleteRegion,
	reqCountryList,
	reqStateList,
...
class DileveryChargesGrocery extends BaseComponent {
	constructor(props) {
		super(props);
		_context = props;
	...
	navigateAddPage() {
		_context.history.push({
			pathname: Constants.SCREEN_ADD_DILEVERY_CHARGES_GROCERY,
		});
	}
	...
	getDriverChargeCList = (selectedOption) => {
		...
		this.props.reqGetDileveryChargeListGrocery(data, this);
	};
	...
	deleteDriverFareItem = (_id) => {
		...
		this.props.reqDeleteDileveryChargeItemGrocery(data, this);
	};
...
DileveryChargesGrocery.propTypes = {
...
export default connect(mapStateToProps, {
	...
	reqStateList,
	reqCityList,
})(withStyles(styles)(DileveryChargesGrocery));
