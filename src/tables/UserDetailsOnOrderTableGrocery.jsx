...
function UserDetailsOnOrderTableGrocery(props) {

    const { classes, data, context, userDetails, style, orderDetails, groceryDetails } = props;
    ...
    function navigateOnMap() {
        ...
        context.props.history.push({
            pathname: Constants.SCREEN_TRACK_ORDER_IN_ADMIN_GROCERY
        });
                    ...
                    <CardActions disableSpacing style={{
                        ...
                        <Grid item xs={3}>
                            <Typography color="textSecondary" style={{
                                ...
                                Grocery Name: {groceryDetails[Constants.KEY_STORE_NAME]}
                            </Typography>
                        </Grid>
                        <Grid item xs={3}>
                            <Typography color="textSecondary" style={{
...
UserDetailsOnOrderTableGrocery.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(UserDetailsOnOrderTableGrocery);