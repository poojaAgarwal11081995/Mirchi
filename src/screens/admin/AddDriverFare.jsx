...
class AddDriverFare extends BaseComponent {
	constructor(props) {
		super(props);
	...
	addDriverDistanceCharge = (array) => {
		...
		this.props.reqAddDriverDistanceCharge(data, this);
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
			...
			if (nextProps[Constants.KEY_TYPE] === types.API_ADD_LOCALITY) {
				...
				nextProps[Constants.KEY_TYPE] === types.API_DRIVER_DISTANCE_CHARGE
			) {
				...
				nextProps[Constants.KEY_TYPE] === types.API_EDIT_DRIVER_DISTANCE_CHARGE
			) {
				toast(nextProps[Constants.KEY_RESPONSE][Constants.KEY_MESSAGE]);
...
export default connect(mapStateToProps, {
	...
	reqStateList,
	reqCityList,
})(withStyles(styles)(AddDriverFare));
