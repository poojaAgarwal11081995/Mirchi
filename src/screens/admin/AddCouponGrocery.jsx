...
import { reqAddCouponGrocery, reqEditCouponGrocery } from "../../actions";
...
class AddCouponGrocery extends BaseComponent {
	constructor(props) {
		super(props);
	...
	addCouponReq = (data) => {
		...
		if (couponDetails != undefined && couponDetails != null) {
			...
			this.props.reqEditCouponGrocery(data, this);
		} else {
			this.props.reqAddCouponGrocery(data, this);
		}
	};
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
			...
			if (
				nextProps[Constants.KEY_TYPE] === types.API_ADDCOUPONCODE_GROCERY ||
				nextProps[Constants.KEY_TYPE] === types.API_EDITCOUPONCODE_GROCERY
			) {
...
export default connect(mapStateToProps, {
	reqAddCouponGrocery,
	reqEditCouponGrocery,
})(withStyles(styles)(AddCouponGrocery));
