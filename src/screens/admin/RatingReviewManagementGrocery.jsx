...
import { reqRatingReviewListGrocery, reqChageOrderStatusGrocery } from '../../actions';
...
import RatingReviewListGrocery from './RatingReviewListGrocery.jsx';

let Grocery_ID = undefined;
let selectedTabObj = undefined;
class RatingReviewManagementGrocery extends BaseComponent {
    constructor(props) {
        super(props)
                        ...
                        <div className={classes.tableContainer}>
                            {
                                selectedTabObj[Constants.KEY_STATUS] == Constants.DRIVER_RETING_REVIEW ?
                                    (<RatingReviewListGrocery dataOb={this.state[Constants.KEY_DATA]}
                                        context={this} classes={classes}
                                        history={this.props.history}


                                    />) : (<RatingReviewListGrocery dataOb={[]}
                                        context={this} classes={classes}
                                        history={this.props.history}
    ...
    handleResponse = (nextProps) => {
        ...
        if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
            ...
            if (nextProps[Constants.KEY_TYPE] === types.API_RATING_REVIEW_LIST_GROCERY) {
                respObj = {
    ...
    getRatingReviewList = () => {
        ...
        var data = {
            [Constants.KEY_Grocery_ID]: Constants.KEY_Grocery_ID,//'5d3bd82d0da6f7aff917bed0',//Grocery_ID,
            [Constants.KEY_RATING_FOR]: Constants.RATING_FOR_GROCERY,
            [Constants.KEY_RATING_FOR]: Constants.RATING_FOR_GROCERY,

        }
        this.props.reqRatingReviewListGrocery(data, this)
    }
...
RatingReviewManagementGrocery.propTypes = {
...
export default connect(mapStateToProps, { reqRatingReviewListGrocery, reqChageOrderStatusGrocery })(withStyles(styles)(RatingReviewManagementGrocery));
