...
import { reqListAdminEarningTimeWise } from '../../actions';
...
class EarringTimeWiseAdmin extends BaseComponent {
    constructor(props) {
        super(props)
                                                            ...
                                                            <ListItem button
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <Grid>
                                                                            <ListItemText
                                                                                primary={itemChild[Constants.KEY_ORDER_DETAILS][Constants.KEY_RETSRO_DETAILS] != undefined && 
                                                                                itemChild[Constants.KEY_ORDER_DETAILS][Constants.KEY_RETSRO_DETAILS][Constants.KEY_NAME]} />
                                                                        </Grid>
                                                                    </Grid>}
    ...
    handleResponse = (nextProps) => {
        ...
        if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
            ...
            if (nextProps[Constants.KEY_TYPE] == types.API_ADMIN_EARNING_PER_WEEK) {
    ...
    listDriverEarning = () => {
        this.props.reqListAdminEarningTimeWise({
...
EarringTimeWiseAdmin.propTypes = {
...
export default connect(mapStateToProps, { reqListAdminEarningTimeWise })(withStyles(styles)(EarringTimeWiseAdmin));
