...
class ProductCategoryDetailGrocery extends BaseComponent {
	constructor(props) {
		super(props);
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
			...
			if (nextProps[Constants.KEY_TYPE] === types.API_EDIT_CATEGORY_GROCERY) {
				respObj = {
					[Constants.KEY_SHOW_PROGRESS]: false,
					disabledClickedBtn: false,
				};
	...
	addEditCate = (event) => {
		...
		this.props.reqEditCateProductGrocery(data, this);
	};
}
...
ProductCategoryDetailGrocery.propTypes = {
...
export default connect(mapStateToProps, {
	reqSelectedCateGrocery,
	reqEditCateProductGrocery,
})(withStyles(styles)(ProductCategoryDetailGrocery));
