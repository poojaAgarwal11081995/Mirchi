...
// RestorentDriverComponent/** @format */
...
import { reqRestorentDriverAdmin } from "../../../../../actions";
...
import RestaurantDriverReportTable from "./RestorentDriverTable";
import * as Utility from "../../../../../utils/Utility";
import CustomPBar from "../../../../../common/CustomPBar";
const animatedComponents = makeAnimated();

let userData = undefined;
class RestorentDriverComponent extends BaseComponent {
	constructor(props) {
		super(props);
	...
	navigateOnDetailsPage(data) {
		...
		this.props.history.push({
			pathname: Constants.SCREEN_RESTAURANT_DRIVER_ID_REPORT,
			[Constants.KEY_DATA]: data,
			// console.log([Constants.KEY_DATA])
		});
	}
	render() {
	...
	getDiscountList = () => {
		...
		this.props.reqRestorentDriverAdmin(data, this);
	};
...
RestorentDriverComponent.propTypes = {
...
export default connect(mapStateToProps, { reqRestorentDriverAdmin })(
	withStyles(styles)(RestorentDriverComponent),
);
