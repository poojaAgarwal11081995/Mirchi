...
export default function DashboardRecentRestro(props) {
...

    {
        Utility.userDetails(userData => {
            if (userData != undefined) {
                ...
                Utility.getFormDataFromObject(dataReq, formData => {
                    reqObj[Constants.KEY_BODY] = formData;
                    console.log('requestData: ' + JSON.stringify(reqObj) + ' API Post: ' + ApiUrls.API_FOR_RECENTDATA_RESTRO_DASHBOARD);
                    fetch(ApiUrls.API_FOR_RECENTDATA_RESTRO_DASHBOARD, reqObj).then(response => response.text())
                        .then(res => {
