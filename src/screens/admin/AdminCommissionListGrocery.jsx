...
import {
	reqDeleteAdminCommissionChargeItemGrocery,
	reqAdminCommissionChargeListGroccery,
	reqRegionList,
	reqDeleteRegion,
	reqCountryList,
	reqStateList,
...
import AdminCommissionTable from "../../tables/AdminCommissionTable";
import AdminCommissionTableGrocery from "../../tables/AdminCommissionTableGrocery";
...
class AdminCommissionListGrocery extends BaseComponent {
	constructor(props) {
		super(props);
		_context = props;
	...
	navigateAddPage() {
		this.props.history.push({
			pathname: Constants.SCREEN_ADD_ADMIN_COMMISSION_GROCERY,
		});
		// _context.history.push({
		//     pathname: Constants.SCREEN_ADD_ADMIN_COMMISSION
		// });
		//alert('sas')
	}
	...
	getDriverChargeCList = (selectedOption) => {
		...
		this.props.reqAdminCommissionChargeListGroccery(data, this);
	};
	...
	deleteDriverFareItem = (_id) => {
		...
		this.props.reqDeleteAdminCommissionChargeItemGrocery(data, this);
	};
	...
	navigateOnDetailsPage(data) {
		...
		this.props.history.push({
			pathname: Constants.SCREEN_ADD_ADMIN_COMMISSION_GROCERY,
			[Constants.KEY_ADMIN_COMMISSION_DETAILS]: data,
		});
	}
}
...
AdminCommissionListGrocery.propTypes = {
...
export default connect(mapStateToProps, {
	...
	reqStateList,
	reqCityList,
})(withStyles(styles)(AdminCommissionListGrocery));
