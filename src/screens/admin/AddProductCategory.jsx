...
import { reqAddCateProduct, reqSelectedCate } from "../../actions";
...
class AddProductCategory extends BaseComponent {
	constructor(props) {
		super(props);
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
			...
			if (nextProps[Constants.KEY_TYPE] === types.API_ADD_CATEGORY) {
				respObj = {
					[Constants.KEY_SHOW_PROGRESS]: false,
					disabledClickedBtn: false,
				};
	...
	addEditCate = (event) => {
		...
		var data = {
			...
			// [Constants.KEY_USERID]: userData[Constants.KEY_USERID] != undefined ? userData[Constants.KEY_USERID] :
			//     userData[Constants.KEY_UNDERSCORE_ID]
		...
		// if (this.state.selectedType != undefined && this.state.selectedType != ''
		//     && this.state.selectedType != null) {
		//     data[Constants.KEY_PARENT_CATEGORY_ID] = this.state.selectedType[Constants.KEY_UNDERSCORE_ID];
		// }

		if (Utility.addCateValidation(data, imageSource, this))
			this.props.reqAddCateProduct(data, this);
	};
...
export default connect(mapStateToProps, { reqSelectedCate, reqAddCateProduct })(
	withStyles(styles)(AddProductCategory),
);
