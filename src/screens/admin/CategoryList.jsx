...
class CategoryList extends BaseComponent {
	...
	navigateAddPage() {
		this.props.history.push({
			pathname: Constants.SCREEN_ADD_CATEGORY,
		});
	}

	navigateDetails() {
		this.props.history.push({
			pathname: Constants.SCREEN_CATEGORIES_DETAIL,
		});
	}
	handleReset() {
		this.setState({
	...
	okayBtnClick = () => {
		if (
			...
			this.props.reqDeleteCategories(data, this);
	...
	updateStatus = (_id, status) => {
		...
		this.props.reqChangeStatusCategory(data, this);
	};
}
