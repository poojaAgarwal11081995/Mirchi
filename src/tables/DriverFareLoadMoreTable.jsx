...
function getHeaderModel(context) {
    ...
    { [Constants.KEY_NAME]: context.strings(StringKeys.Fare) },
...
function DriverFareLoadMoreTable(props) {
    ...
    return (
        <div child={this} className={classes.root}
            ...
            <label >{context.strings(StringKeys.PerKmCharge)}</label>
                    ...
                    <label style={{
                        ...
                        for (const key in data) {
                            if (data.hasOwnProperty(key)) {
                                ...
                                if (Utility.checkFareValidationOnLoadMore(element, context, key, data)) {
...
DriverFareLoadMoreTable.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(DriverFareLoadMoreTable);