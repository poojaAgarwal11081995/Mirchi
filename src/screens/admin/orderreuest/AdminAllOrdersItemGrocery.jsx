...
function AdminAllOrdersItemGrocery(props) {
			...
			<Table className={classes.table}>
				<TableHead>
					<TableRow>
						...
						<TableCell align="justify">Vender Name</TableCell>
...
AdminAllOrdersItemGrocery.propTypes = {
	classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(AdminAllOrdersItemGrocery);
