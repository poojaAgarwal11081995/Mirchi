...
function GeneralIssueList(props) {
	...
	function handleClose(option, pos) {
		...
		if (option != undefined) {
			...
			if (option == Constants.CHECK_ORDERS) {
				...
				CustomStorage.setSessionDataAsObject(Constants.KEY_RESTO_DETAILS, n);
				context.props.history.push({
					pathname: Constants.SCREEN_RESTAURENT_EARNING,
					[Constants.KEY_RESTO_DETAILS]: n,
				});
			}
		}
				...
				<TableHead>
					<TableRow>
						<TableCell align="justify" style={CommonStyle.tableRowHeader}>
							{context.strings(StringKeys.General_Issue)}
						</TableCell>
						{/* <TableCell align="center" style={CommonStyle.tableRowHeader}>{context.strings(StringKeys.Phone)}</TableCell>
                        <TableCell align="center" style={CommonStyle.tableRowHeader}>{context.strings(StringKeys.City)}</TableCell>
                        <TableCell align="center" style={CommonStyle.tableRowHeader}>Created At</TableCell>
                        <TableCell align="center" style={CommonStyle.tableRowHeader}>{context.strings(StringKeys.Stauts)}</TableCell>
                        <TableCell align="center" style={CommonStyle.tableRowHeader}>Doc Verified</TableCell>
                        <TableCell align="center" style={CommonStyle.tableRowHeader}>{context.strings(StringKeys.Action)}</TableCell> */}
					</TableRow>
				</TableHead>
				<TableBody>
					{data != undefined
						? data
                            ...
                            <TableCell align="center">{n.city != undefined ? n.city.name : ''}</TableCell>
...
export default withStyles(styles)(GeneralIssueList);
