...
import {
	reqDeleteAdminCommissionChargeItem,
	reqAdminCommissionChargeList,
	reqRegionList,
	reqDeleteRegion,
	reqCountryList,
	reqStateList,
...
class AdminCommissionList extends BaseComponent {
	constructor(props) {
		super(props);
		_context = props;
	...
	getDriverChargeCList = (selectedOption) => {
		...
		this.props.reqAdminCommissionChargeList(data, this);
	};
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
			...
			if (nextProps[Constants.KEY_TYPE] === types.API_LOCALITY_LIST) {
				...
				nextProps[Constants.KEY_TYPE] === types.API_ADMIN_COMMISSION_CHARGE_LIST
			) {
				respObj = {
					[Constants.KEY_SHOW_PROGRESS]: false,
					[Constants.KEY_DATA]:
	...
	deleteDriverFareItem = (_id) => {
		...
		this.props.reqDeleteAdminCommissionChargeItem(data, this);
	};
...
export default connect(mapStateToProps, {
	...
	reqStateList,
	reqCityList,
})(withStyles(styles)(AdminCommissionList));
