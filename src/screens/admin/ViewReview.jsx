...
import { reqAddProduct, reqOrderDetails } from "../../actions";
...
class ViewReview extends BaseComponent {
	constructor(props) {
		...
		this.state = {
			...
			[Constants.KEY_RETSRO_DETAILS]: undefined,
	...
	componentDidMount() {
		...
		console.log("vxgh", this.props.location);
		...
		this.setState({
			[Constants.KEY_RETSRO_DETAILS]: this.props.location.param[
	...
	render() {
		...
		{
			console.log("Order details :::", this.state[Constants.KEY_RATING_FROM]);
		}
								...
								<Typography className={classes.pos} color="textSecondary">
									...
									Constants.RATING_FOR_USER
										...
										? this.state[Constants.KEY_DRIVER_DETAILS] != undefined
											...
											: Constants.RATING_NOT
										: this.state[Constants.KEY_RATING_FROM] ==
										  Constants.RATING_FOR_RESTRO
										? this.state[Constants.KEY_RETSRO_DETAILS] != undefined
											? this.state[Constants.KEY_RETSRO_DETAILS][
													Constants.KEY_NAME
											  ] + Constants.RATING_R
											: Constants.RATING_NOT
										: ""}
...
export default connect(mapStateToProps, { reqOrderDetails, reqAddProduct })(
