...
function DileveryChargeLoadMoreTableGrocery(props) {
...
DileveryChargeLoadMoreTableGrocery.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(DileveryChargeLoadMoreTableGrocery);