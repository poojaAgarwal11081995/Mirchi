...
import { reqChangeStatusCouponGrocery, reqCouponListGrocery, reqDeleteCouponGrocery } from '../../actions';
...
class CouponManagementGrocery extends BaseComponent {
    constructor(props) {
        super(props)
    ...
    navigateAddPage() {
        this.props.history.push({
            pathname: Utility.isAdmin() ? Constants.SCREEN_ADD_COUPON_ADMIN_GROCERY : Constants.SCREEN_ADD_COUPON_GROCERY
        });
    }
...

                    {
                        (this.state.headerData !== undefined && this.state.headerData.length > 0) ?
                            ...
                            <div style={{ marginTop: 15 }} className={classes.tableContainer}>
                                <CouponTable data={this.state[Constants.KEY_DATA]}
                                    context={this}
                                />
                            </div>
                            : null
    ...
    handleResponse = (nextProps) => {
        ...
        if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
            ...
            if (nextProps[Constants.KEY_TYPE] === types.API_LISTCOUPONCODE_GROCERY) {
    ...
    getCouponList = () => {
        ...
        this.props.reqCouponListGrocery(data, this)
    }
...
CouponManagementGrocery.propTypes = {
...
export default connect(mapStateToProps, { reqChangeStatusCouponGrocery, reqCouponListGrocery, reqDeleteCouponGrocery })(withStyles(styles)(CouponManagementGrocery));
