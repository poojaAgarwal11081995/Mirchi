...
import { reqIteamWiseSaleGroceryReportList } from "../../../../../actions";
...
import IteamWiseGroceryTable from "./IteamWiseGroceryTable";
...
let TEXTFIELD_XS = 12;
class OrderReportIteamWiseGroceryComponent extends BaseComponent {
	constructor(props) {
		super(props);
	...
	getDiscountList = () => {
		...
		this.props.reqIteamWiseSaleGroceryReportList(data, this);
	};
	...
	handleResponse = (nextProps) => {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
			...
			if (
				...
				// alert(nextProps[Constants.KEY_DATA]["order_list"]);
				respObj = {
...
OrderReportIteamWiseGroceryComponent.propTypes = {
...
export default connect(mapStateToProps, { reqIteamWiseSaleGroceryReportList })(
	withStyles(styles)(OrderReportIteamWiseGroceryComponent),
);
