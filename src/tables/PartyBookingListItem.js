...
function PartyBookingListItem(props) {
			...
			<Table className={classes.table}>
				<TableHead>
					<TableRow>
						...
						<TableCell align="center">Party Date</TableCell>
						...
						? data
								...
								.map((n, index) => (
									<TableRow key={n.id}>
										...
										<TableCell align="center">
											{n.venue != undefined ? n.venue : ""}
										</TableCell>

										<TableCell align="center">
											{n.type != undefined ? n.type : ""}
										</TableCell>

										<TableCell align="center">
											{n.person_count != undefined ? n.person_count : ""}
										</TableCell>
	...
	function handleResponse(nextProps) {
		...
		if (nextProps.hasOwnProperty(Constants.KEY_SHOW_PROGRESS)) {
			...
			if (nextProps[Constants.KEY_TYPE] === types.API_PARTY_BOOKING_LISTING) {
				...
				this.setState(respObj);
				context.getPartySearchList();
			}
		}
	}

	function deletePartyBooking(id) {
...
PartyBookingListItem.propTypes = {
	classes: PropTypes.object.isRequired,
};
function mapStateToProps({ response }) {
	return response;
}
export default withStyles(styles)(PartyBookingListItem);
