...
import { reqDriverDocStatusChange, reqChangeStatusDriver, reqDriverList, reqDeleteDriver, reqRegionList, reqCountryList, reqStateList, reqCityList, reqListDriverEarning } from '../../actions';
...
class EarringPage extends BaseComponent {
    constructor(props) {
        super(props)
    ...
    listDriverEarning = () => {
        this.props.reqListDriverEarning({
    ...
    handleResponse = (nextProps) => {
        ...
        if (nextProps.hasOwnProperty(Constants.KEY_RESPONSE)) {
            ...
            if (nextProps[Constants.KEY_TYPE] === types.API_LIST_DRIVER_EARNING) {
                respObj = {
                    [Constants.KEY_SHOW_PROGRESS]: false,
    ...
    navigateEarringPage(item) {
        ...
        this.props.history.push({
            pathname: Constants.SCREEN_EARRING_TIMEWISE,
        });
    }
...
export default connect(mapStateToProps, { reqDriverDocStatusChange, reqChangeStatusDriver, reqDriverList, reqDeleteDriver, reqRegionList, reqCountryList, reqStateList, reqCityList, reqListDriverEarning })(withStyles(styles)(EarringPage));
