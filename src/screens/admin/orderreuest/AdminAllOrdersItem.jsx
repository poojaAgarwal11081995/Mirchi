...
function AdminAllOrdersItem(props) {
	console.log("propsPages++++++++++", props);
	const { classes, dataOb, context, check, pages } = props;
	...
	//console.log("number of page" ,rowsPerPage );
...
AdminAllOrdersItem.propTypes = {
	classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(AdminAllOrdersItem);
