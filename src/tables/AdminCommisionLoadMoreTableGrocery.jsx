...
function AdminCommisionLoadMoreTableGrocery(props) {
...
AdminCommisionLoadMoreTableGrocery.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(AdminCommisionLoadMoreTableGrocery);